...
class UpdateHrProfileRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'employment_status' => ['nullable', 'in:active,exited'],
            'exit_date' => ['required_if:employment_status,exited', 'nullable', 'date'],
            'exit_reason' => ['required_if:employment_status,exited', 'nullable', 'string', 'max:1000'],
