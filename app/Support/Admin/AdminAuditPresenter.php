...
class AdminAuditPresenter
{
    ...
    public static function actionLabel(string $action): string
    {
        return match ($action) {
            ...
            'jobs.removed' => 'Deleted a job log',
            ...
            'reviews.removed' => 'Deleted a review',
            'cases.referred' => 'Referred a case to operations',
            'cases.escalated' => 'Escalated a case to Super Admin',
            'cases.escalation_completed' => 'Resolved a Super Admin escalation',
            'cases.referral_completed' => 'Completed a referred case',
            'users.delete', 'users.deleted' => 'Deleted an artisan account',
            'approvals.approved' => 'Approved an operations request',
            'approvals.rejected' => 'Rejected an operations request',
